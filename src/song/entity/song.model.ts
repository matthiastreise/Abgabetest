...
export const songSchema = new Schema(
    {
        ...
        produzent: { type: String, required: true },
        interpret: {
            type: String,
            required: true,
            enum: [
        ...
        lauflaenge: { type: Number, required: true },
    },
    {
...
export const SongModel = model('Song', songSchema); // eslint-disable-line @typescript-eslint/naming-convention
