...
import { SongFileRequestHandler } from './song-file.request-handler';
import { SongRequestHandler } from './song.request-handler';

const handler = new SongRequestHandler();
const fileHandler = new SongFileRequestHandler();
