...
// nullish coalescing
const dbName = dbConfigEnv.name ?? 'swefilm';
const host = dbConfigEnv.host ?? 'mongodb';
const atlas = host.endsWith('w=majority');
const port = 27_017;
...
if (atlas) {
    ...
    url =
        'mongodb+srv://alexander:AFJHiKeMpd669Ns@cluster0.pluyf.mongodb.net/swefilm?retryWrites=true&w=majority';
